...
public class Question5 {
	...
	public static void main(String[] args) {
		...
		// Al añadir un valor fuera del rango (el rango es "a" a "d")
		// Causa una excpeción:
		...
		System.out.println("Después de añadir un valor a 'subMap'");
		for (Entry<String, String> entrySet : smap.entrySet()) {
			System.out.println("Key: " + entrySet.getKey() + ", Value: " + entrySet.getValue());
		}
		
		System.out.println("Después de añadir un valor al 'map'");
